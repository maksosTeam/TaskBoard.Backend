    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VisibilityLinks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VisibilityLinks_Projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "Projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Documents_UserEntity_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_items_sprints", x => new { x.item_id, x.sprint_id });
                    table.ForeignKey(
                        name: "FK_items_sprints_Items_item_id",
                        column: x => x.item_id,
                        principalTable: "Items",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_items_sprints_Sprints_sprint_id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_items_sprints_sprint_id",
                table: "items_sprints",
                column: "sprint_id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VisibilityLinks_ProjectId",
                table: "VisibilityLinks",
                column: "ProjectId");
        }
